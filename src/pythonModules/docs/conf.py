...
project = u'MeteorPi'
copyright = u'2015, Dominic Ford, Tom Oinn, Mark Calleja, Dave Ansell'
author = u'Dominic Ford, Tom Oinn, Mark Calleja, Dave Ansell'
...
latex_documents = [
    (master_doc, 'MeteorPi.tex', u'MeteorPi Documentation',
     u'Dominic Ford, Tom Oinn, Mark Calleja, Dave Ansell', 'manual'),
]
