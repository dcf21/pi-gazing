...
rawImgToPng       = '%(binary_path)s/rawimg2png               %(input)s %(filename_out)s %(barrel_a)s %(barrel_b)s %(barrel_c)s'
rawImgToPng3      = '%(binary_path)s/rawimg2png3              %(input)s %(filename_out)s %(barrel_a)s %(barrel_b)s %(barrel_c)s'
