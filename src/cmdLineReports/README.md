The python scripts in this directory are used to provide basic reports about the number and type of observations recorded in the local Meteor Pi database.
