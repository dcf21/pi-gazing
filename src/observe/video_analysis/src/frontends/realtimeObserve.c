...
// Observe the night sky using a web cam, and pass the frames to the analysis code in real time, to generate
// long-exposure time-lapse frames, and to search for moving objects.
