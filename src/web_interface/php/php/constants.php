...
class constants
{
    ...
    public function __construct()
    {
        ...
        $this->semanticTypes = [
            ...
            "pigazing:movingObject/maxBrightness" => ["Maximum brightness", "This image shows the maximum brightness of each part of the image over the course of the object's appearance. This is usually the image that shows the object most clearly."],
            ...
            "pigazing:movingObject" => ["Video of object", "This is a video of the object which triggered the camera"],
            "pigazing:timelapse/skyBackground" => ["Light pollution map","This is an image of the light pollution that we believe to be present in this image, compiled from observations over the previous 20 minutes. It is subtracted from the observed image to see faint objects."],
