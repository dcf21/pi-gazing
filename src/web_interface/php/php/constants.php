...
class constants
{
    ...
    public function __construct()
    {
        ...
        $this->metadataFields = [
            ...
            "plane:angular_offset" => "Aircraft: Angular mismatch (deg)",
            "plane:call_sign" => "Aircraft: call sign",
            "plane:clock_offset" => "Aircraft: Ephemeris clock offset (sec)",
            ...
            "triangulation:mean_altitude" => "Triangulation: Altitude (km)",
