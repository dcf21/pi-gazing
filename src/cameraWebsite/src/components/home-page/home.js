define(["knockout", "text!./home.html", "client", "router", "utils"], function (ko, homeTemplate, client, router, utils) {
    ...
    function HomeViewModel(route) {
        ...
        self.items = [ {"camera":"Cambridge-South-East", "time":1445279601, "caption":"Bright satellite detected by our camera in south-east Cambridge."},
                       {"camera":"Bury-St-Edmunds"     , "time":1443324016, "caption":"Bright aircraft detected by our camera in Bury St Edmunds."},
                       {"camera":"Bury-St-Edmunds"     , "time":1444501594, "caption":"Bright satellite detected by our camera in Bury St Edmunds."},
                       {"camera":"Cambridge-South-East", "time":1446932348, "caption":"Bright shooting star detected by our camera in south-east Cambridge."},
                       {"camera":"Bury-St-Edmunds"     , "time":1446958905, "caption":"Beautiful conjunction between the Moon and planets, seen from Bury St Edmunds. From the left, the four bright objects in a diagonal line are the Moon, Venus, Mars and Jupiter. Mars is much fainter than the others."}
                     ];
